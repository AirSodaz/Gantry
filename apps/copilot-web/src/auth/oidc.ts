...
const issuer =
  import.meta.env.VITE_COPILOT_OIDC_ISSUER ??
  "http://gantry-dex.localhost:5556/dex";
const localMetadata = import.meta.env.DEV
  ...
  : undefined;
const clientId =
  import.meta.env.VITE_COPILOT_OIDC_CLIENT_ID ?? "gantry-copilot-web";
const scope =
  import.meta.env.VITE_COPILOT_OIDC_SCOPE ??
  "openid profile email audience:server:client_id:gantry-copilot-api";

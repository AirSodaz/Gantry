    ...
    await Promise.all(
      Array.from(files).map(async (file) => {
        ...
        try {
          ...
          updateAttachment(localId, { state: "uploading", attachment: attachment.attachment });
          ...
          const completed = await api.completeAttachment(attachment.attachment.id);
          if (
            completed.state !== "available" ||
            completed.scan_state !== "passed"
          ) {

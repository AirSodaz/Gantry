...
export function ArtifactDetailPage() {
  ...
  return <div className="page-wrap narrow-page artifact-detail-page">
    ...
    <Button disabled={!available || downloading} onClick={() => void download()}><Download size={16} /> {downloading ? 'Preparing download...' : available ? 'Download' : 'Download unavailable'}</Button>
    {downloadError ? <p className="inline-error" role="alert">Download failed. Try again.</p> : null}
  </div>;
}

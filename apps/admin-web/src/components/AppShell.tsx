...
export function AppShell() {
  ...
  const name =
    user?.profile.preferred_username ?? user?.profile.name ?? "Administrator";
  ...
  const isNewAgentActive =
    location.pathname === "/new" || location.pathname === "/agents/new";

  return (
    <div
      className={`admin-shell ${isCollapsed ? "admin-shell-collapsed" : ""}`}
    >
      <aside
      ...
      >
        <div className="admin-sidebar-header">
          <div className="admin-brand">
            ...
            {!isCollapsed ? (
              <span className="admin-brand-title">Gantry Admin</span>
            ) : null}
          </div>
          <IconButton
        ...
        <nav className="admin-nav" aria-label="Admin navigation">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `admin-nav-link ${isActive ? "admin-nav-link-active" : ""} ${isCollapsed ? "admin-nav-link-collapsed" : ""}`
            }
          >
            <Gauge size={17} className="admin-nav-icon" />
          ...
          {!isCollapsed ? (
            <span className="admin-nav-label admin-nav-label-spaced">
              Configuration
            </span>
          ) : (
          ...
          >
            <Layers3 size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Skills</span> : null}
          </NavLink>
          <NavLink
            to="/plugins"
            title={isCollapsed ? "Plugins" : undefined}
            className={({ isActive }) =>
              `admin-nav-link ${isActive ? "admin-nav-link-active" : ""} ${isCollapsed ? "admin-nav-link-collapsed" : ""}`
            }
          >
            <Database size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Plugins</span> : null}
          </NavLink>
          <NavLink
            to="/tools"
          ...
          >
            <Cable size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Tools</span> : null}
          </NavLink>
          ...
          >
            ...
            {!isCollapsed ? <span>Runs</span> : null}
          </NavLink>
          <NavLink
            to="/evaluations"
          ...
          >
            <ClipboardCheck size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Evaluations</span> : null}
          </NavLink>
          ...
          >
            <FileSearch size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Audit</span> : null}
          </NavLink>
          <NavLink
            to="/policies"
          ...
          >
            <Shield size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Policies</span> : null}
          </NavLink>
          <NavLink
            to="/integrations"
          ...
          >
            <PlugZap size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Integrations</span> : null}
          </NavLink>
          ...
          >
            <ServerCog size={17} className="admin-nav-icon" />
            {!isCollapsed ? <span>Platform</span> : null}
          </NavLink>
          <NavLink

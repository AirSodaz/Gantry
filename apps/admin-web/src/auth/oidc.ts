...
const issuer =
  import.meta.env.VITE_ADMIN_OIDC_ISSUER ??
...
const localMetadata = import.meta.env.DEV
  ...
  : undefined;
const clientId =
  import.meta.env.VITE_ADMIN_OIDC_CLIENT_ID ?? "gantry-admin-web";
const scope =
  import.meta.env.VITE_ADMIN_OIDC_SCOPE ??
  "openid profile email audience:server:client_id:gantry-admin-api";

...
} from "./features/evaluations/EvaluationPages";
import {
  IntegrationsPage,
  IntegrationDetailPage,
} from "./features/integrations/IntegrationPages";
import {
  PlatformPage,
  ProviderRoutesPage,
    ...
    return (
      <main className="admin-sign-in">
        <section>
          ...
          <p>
            Sign in to manage named Drafts, immutable Revisions, and exact
            Deployments.
          </p>
          {error ? (
            <p
  ...
  return (
    <Routes>
      <Route element={<AppShell />}>
        ...
        />
        <Route
          path="agents/:agentId/revisions/:revisionHash"
          element={<AgentVersionPage />}
        />
        <Route path="skills" element={<SkillsPage />} />
        <Route
          path="skills/:assetId"
          element={<AssetDetailPage kind="skills" />}
        />
        <Route path="plugins" element={<PluginsPage />} />
        <Route
          path="plugins/:assetId"
          element={<AssetDetailPage kind="plugins" />}
        />
        <Route path="tools" element={<ToolsPage />} />
        <Route
          path="tools/:assetId"
          element={<AssetDetailPage kind="tools" />}
        />
        ...
        <Route
          path="platform/providers/:providerId"
          element={<ProviderRoutesPage />}
        />

...
export type EvaluationRegression = Components['schemas']['EvaluationRegression'];
export type EvaluationRegressionList = Components['schemas']['EvaluationRegressionList'];
